...
describe('StatsEngine e2e', () => {
  ...
  function seedFullWeek(repo: InMemoryRepo) {
    // 3 services
    const svcBath = { id: 'svc-bath', name: 'Baño completo', durationMin: 60, priceCents: 2500000, upsells: ['Corte de uñas'] };
    const svcGroom = { id: 'svc-groom', name: 'Corte y peinado', durationMin: 90, priceCents: 3500000, upsells: [] };
    const svcSpa = { id: 'svc-spa', name: 'Spa de mascotas', durationMin: 120, priceCents: 5000000, upsells: [] };
